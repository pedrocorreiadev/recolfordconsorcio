    ...
    <main className="min-h-screen bg-[#f7f9fc] text-[#0b1d36]">
      ...
      <section className="pt-[116px]">
        <div className="mx-auto max-w-3xl px-5 py-14 lg:px-8">
          <span className="text-xs font-extrabold tracking-[.18em] text-[#b57708]">PERFIL PREVISTO</span>
          <h1 className="mt-3 text-4xl font-black tracking-[-.04em] sm:text-5xl">{specialist.name}</h1>
          <p className="mt-4 text-lg leading-8 text-[#6b7b8f]">
            Este perfil fazia parte da proposta de atendimento do site. Ele foi mantido como peça visual do protótipo.
          </p>
          <div className="mt-10">
